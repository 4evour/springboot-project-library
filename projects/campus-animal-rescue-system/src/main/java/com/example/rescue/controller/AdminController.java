...
import com.example.rescue.service.UserService;
...
public class AdminController extends BaseController {
    ...
    public ApiResponse<Void> status(@PathVariable Long id, @RequestBody Map<String, Object> input, HttpSession session) {
        requireAdmin(session);
